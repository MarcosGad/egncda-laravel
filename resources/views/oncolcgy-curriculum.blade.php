    ...
    <div class="booksopen">
        <div class="row">                        
             ...
             @foreach ($oncolcgycurriculums as $oncolcgycurriculum)
                     ...
                     <a href="/oncology-{{Str::slug($oncolcgycurriculum->name)}}" style="text-decoration:none">

                     <div class="card card-icon">

                    <p class="book-mange"> <i class="fas {{$oncolcgycurriculum->icon}}"></i></p>
                         <hr>
                         <div class="card-body">
                           <h5 class="card-title">{{$oncolcgycurriculum->name}}</h5>
                          </div>
