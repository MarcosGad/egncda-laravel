    ...
    <div class="booksopen">
        <div class="row">                        
             ...
             @foreach ($miscellaneouscurriculums as $miscellaneouscurriculum)
                     ...
                     <div class="certificate-miscellaneous">  
                     <a href="/certificate-{{Str::slug($miscellaneouscurriculum->name)}}" style="text-decoration:none">

                     <div class="card card-icon">

                    <p class="book-mange"> <i class="fas {{$miscellaneouscurriculum->icon}}"></i></p>
                         <hr>
                         <div class="card-body">
                           <h5 class="card-title">{{$miscellaneouscurriculum->name}}</h5>
                      </div>
