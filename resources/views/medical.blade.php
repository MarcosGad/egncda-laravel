            ...
            <div class="row">
                ...
                <div class=" col-md-3 col-sm-12">
                    ...
                    <a href="/{{Str::slug($cat->name)}}">
                        <p class="parent-icon-five"><i class="fas {{$cat->icon}}"></i></p>
                    </a>
                ...
                <div class=" col-md-3 col-sm-12">
                    <div class="gallery">
                        <div>
                            <a href="/certificate-miscellaneous"><img src="img/Miscellaneous.png" class="card-img-top"
                                    alt="Miscellaneous"> <span class="overlay"></span></a>
                        </div>
                    </div>

                    <a href="/certificate-miscellaneous">
                        <p class="parent-icon-five"><i class="fas fa-user-md"></i></p>
                    </a>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <ul class="ul-footer">
                        ...
                        @if (!Auth::guest())
                        @if(auth()->user()->user_type == 1)
                        <li><i class="fas fa-chevron-right"></i> <a href="{{ route('certificate') }}">Certificate</a>
                        </li>
                        @endif
                        @endif
