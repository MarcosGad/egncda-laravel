    ...
    <div class="booksopen">
        <div class="row">                        
             ...
             @foreach ($respiratorycurriculums as $respiratorycurriculum)
                     <div class="col-md-6">
                     <a href="/respiratory-{{Str::slug($respiratorycurriculum->name)}}" style="text-decoration:none">

                     <div class="card card-icon">

                    <p class="book-mange"> <i class="fas {{$respiratorycurriculum->icon}}"></i></p>
                         <hr>
                         <div class="card-body">
                           <h5 class="card-title">{{$respiratorycurriculum->name}}</h5>
                      </div>
