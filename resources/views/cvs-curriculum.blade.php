    ...
    <div class="booksopen">
        <div class="row">                        
             ...
             @foreach ($cvscurriculums as $cvscurriculum)
                     <div class="col-md-6">
                     <a href="/cvs-{{Str::slug($cvscurriculum->name)}}" style="text-decoration:none">

                     <div class="card card-icon">

                    <p class="book-mange"> <i class="fas {{$cvscurriculum->icon}}"></i></p>
                         <hr>
                         <div class="card-body">
                           <h5 class="card-title">{{$cvscurriculum->name}}</h5>
                      </div>
