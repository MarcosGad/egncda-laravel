    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption">
                    <p class="desc-title">EGNCDA Non— GovernrnentaI Organization, Managed by board of directors. The
                        alliance works with the efforts of 25 nonprofit organizations, all of which cooperate against
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption">
                    <p class="desc-title">Aim to raise awareness about NCD in public through a lot of activities of our
                        alliance successfully achieved, as EgNCDA is one of the 10 alliances receiving the 2019 ENOUGH.
                        Campaign Fuel Award for workplace wellness activities and social media, radio and television
                        advocacy</p>
                </div>
            </div>
        </div>
