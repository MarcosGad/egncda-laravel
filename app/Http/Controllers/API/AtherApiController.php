...
//categoriesofdoctors
    ...
    public function certificate_miscellaneous()
    {
        $certificate_miscellaneous =  DB::select('select * from categoriesofdoctors');
        return response()->json($certificate_miscellaneous);
    }
...
//basic resources
    ...
    public function certificateMiscellaneousBasicResources()
    {
        $certificateMiscellaneousBasicResources =  DB::select('select * from basic_managements');
        return response()->json($certificateMiscellaneousBasicResources);
    }
...
//books
    ...
    {
        $certificate_books =  DB::select('select * from flights where cat_id = 5 and categoriesofdoctors_id = 1 and basicmanagements_id = 1');
        return response()->json($certificate_books);
    }
...
//curriculum
    ...
    {
        $certificate_curriculum =   DB::select('select * from miscellaneouscurriculums');
        return response()->json($certificate_curriculum);
    }
   ...
   //assessment
    ...
    public function certificateAssessment()
    {
        $questionnaires = \App\Questionnaire::all()->where('cat_id','=','5')->where('categoriesofdoctors_id','=','5');
        $scoure = DB::table('doc_scoures')->where('doctor_id','=', Auth::id())->sum('scoure');
        return response()->json(['questionnaires'=>$questionnaires,'scoure'=>$scoure]);
...
{
    $certificate_clinical_scenarios =  DB::select('select * from flights where cat_id = 5 and categoriesofdoctors_id = 2');
    return response()->json($certificate_clinical_scenarios);
}
...
{
    $certificate_updates_news =  DB::select('select * from flights where cat_id = 5 and categoriesofdoctors_id = 4');
    return response()->json($certificate_updates_news);
}
...
{
    $certificate_guidelines =  DB::select('select * from flights where cat_id = 5 and categoriesofdoctors_id = 3');
    return response()->json($certificate_guidelines);
}
...
{
    $certificate_smoking_cessation =  DB::select('select * from flights where cat_id = 5 and categoriesofdoctors_id = 1 and basicmanagements_id = 2 and miscellaneouscurriculums_id = 1');
    return response()->json($certificate_smoking_cessation);
}

public function certificate_obesity_and_nutrition()
{
    $certificate_obesity_and_nutrition=  DB::select('select * from flights where cat_id = 5 and categoriesofdoctors_id = 1 and basicmanagements_id = 2 and miscellaneouscurriculums_id = 2');
    return response()->json($certificate_obesity_and_nutrition);
}

public function certificate_mental_health()
{
    $certificate_mental_health=  DB::select('select * from flights where cat_id = 5 and categoriesofdoctors_id = 1 and basicmanagements_id = 2 and miscellaneouscurriculums_id = 3');
    return response()->json($certificate_mental_health);
}

public function certificate_country_specific_health_issues()
{
    $certificate_country_specific_health_issues=  DB::select('select * from flights where cat_id = 5 and categoriesofdoctors_id = 1 and basicmanagements_id = 2 and miscellaneouscurriculums_id = 4');
    return response()->json($certificate_country_specific_health_issues);
}

public function certificate_basics_of_gcp_and_research()
{
    $certificate_basics_of_gcp_and_research=  DB::select('select * from flights where cat_id = 5 and categoriesofdoctors_id = 1 and basicmanagements_id = 2 and miscellaneouscurriculums_id = 5');
    return response()->json($certificate_basics_of_gcp_and_research);
}


public function certificate_basics_of_medical_statistics()
{
    $certificate_basics_of_medical_statistics=  DB::select('select * from flights where cat_id = 5 and categoriesofdoctors_id = 1 and basicmanagements_id = 2 and miscellaneouscurriculums_id = 6');
    return response()->json($certificate_basics_of_medical_statistics);
}

public function certificate_conflict_resolution_and_basic_communication_skills()
{
    $certificate_conflict_resolution_and_basic_communication_skills=  DB::select('select * from flights where cat_id = 5 and categoriesofdoctors_id = 1 and basicmanagements_id = 2 and miscellaneouscurriculums_id = 7');
    return response()->json($certificate_conflict_resolution_and_basic_communication_skills);
}


public function certificate_physical_exercise()
{
    $certificate_physical_exercise=  DB::select('select * from flights where cat_id = 5 and categoriesofdoctors_id = 1 and basicmanagements_id = 2 and miscellaneouscurriculums_id = 8');
    return response()->json($certificate_physical_exercise);
}

public function certificate_digital_health()
{
    $certificate_digital_health=  DB::select('select * from flights where cat_id = 5 and categoriesofdoctors_id = 1 and basicmanagements_id = 2 and miscellaneouscurriculums_id = 9');
    return response()->json($certificate_digital_health);
}
