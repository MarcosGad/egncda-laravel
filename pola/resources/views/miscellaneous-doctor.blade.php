    ...
    <div class="card-deck">                       
        <div class="row">
                ...
                @foreach ($categoriesofdoctors as $categoriesofdoctor)   
                    <div class="col-md-4"> 
                      <a href="/miscellaneous-{{Str::slug($categoriesofdoctor->name)}}"  style="text-decoration:none">
                             
                        <div class="card card-icon">
                        <p class="book-mange"><i class="fas {{$categoriesofdoctor->icon}}"></i></p>
                         
                         <hr>
                         
                         <div class="card-body">
                           <h5 class="card-title">{{$categoriesofdoctor->name}}</h5>
                         </div>
