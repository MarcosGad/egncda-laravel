    ...
    <div class="books">
        <div class="row">                        
             ...
             @foreach ($basicmanagements as $basicmanagement)
                     <div class="col-md-6">
                     <a href="/miscellaneous-{{Str::slug($basicmanagement->name)}}" style="text-decoration:none">

                     <div class="card card-icon">

                    <p class="book-mange"> <i class="fas {{$basicmanagement->icon}}"></i></p>
                         <hr>
                         <div class="card-body">
                           <h5 class="card-title">{{$basicmanagement->name}}</h5>
                      </div>
